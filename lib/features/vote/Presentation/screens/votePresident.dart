...
class VotePresident extends StatefulWidget {
  @override
  _VotePresidentState createState() => _VotePresidentState();
}

class _VotePresidentState extends State<VotePresident> {
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: TextButton(
                      onPressed: () {
                        showDialog(context: context, builder: (dialogPresidentContext) {
                            return AlertDialog(
                              title: Align(
